...
int draw_rotate_value(int cdx, int cdy, int ctx, int cty, float zoom, U32 angle, DrawRaw_value* draw_value)
{
	float sinval, cosval;
...
#if 0
	case LEFT_BOTTOM_SCREEN:
		draw_value.InitSX = 0, draw_value.InitSY = 0;
		draw_value.dxSx = 512, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 512;
		break;
	case LEFT_TOP_SCREEN:
		draw_value.InitSX = 0, draw_value.InitSY = -61440;
		draw_value.dxSx = 512, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 512;
		break;
	case RIGHT_BOTTOM_SCREEN:
		draw_value.InitSX = 0, draw_value.InitSY = -122880;
		draw_value.dxSx = 512, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 512;
		break;
	case RIGHT_TOP_SCREEN:
		draw_value.InitSX = 0, draw_value.InitSY = -184320;
		draw_value.dxSx = 512, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 512;
		break;
#endif
