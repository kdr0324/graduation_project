...
Stair_Down2cm:
    ...
    SPEED 8
    MOVE G6D, 104,  25, 150,  160, 96
    MOVE G6A,102, 100, 165, 50, 98
    WAIT
    GOSUB All_motor_mode3
    ...
    SPEED 8
    MOVE G6A, 100, 140,  100,  81,  100,
    MOVE G6D,  100,  30, 120, 164, 100,
    MOVE G6B, 114,  42,  80,  ,  ,
    MOVE G6C, 108,  49,  81,  ,  ,
    WAIT
...
Stair_Up2cm:
    ...
    MOVE G6D,113,  73, 155,  87,  93
    WAIT


    SPEED 12
    MOVE G6A,  80, 40, 115, 160, 114,
    MOVE G6D,113,  70, 155,  85,  94
    WAIT
