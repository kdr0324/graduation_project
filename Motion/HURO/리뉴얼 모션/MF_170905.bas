...
MINE_RUN_READY:
    ...
    '다리 벌리기
    MOVE G6A, 80, 70, 145, 105, 120
    MOVE G6D, 80, 70, 145, 105, 120
    MOVE G6C, , 55
    MOVE G6B, , 55
    WAIT
    DELAY 100
    ...
    '다리 기울이기
    MOVE G6A, 70, 70, 145, 105, 120
    MOVE G6D, 90, 70, 145, 105, 115
    WAIT

    '왼발들기
    MOVE G6A, 70, 80, 125, 115, 120
    MOVE G6D, 90, 70, 145, 105, 120
    MOVE G6C, 80
    MOVE G6B, 120
    WAIT

    '다리 벌리기
    MOVE G6A, 80, 40, 175, 105, 120
    MOVE G6D, 80, 70, 145, 105, 120
    WAIT
...
MINE_RUNNING:
    ...
    '다리기울이기 (오른쪽)
    MOVE G6A, 70, 40, 175, 105, 120
    MOVE G6D, 90, 70, 145, 105, 120
    WAIT

    '오른발들기
    MOVE G6D, 70, 80, 125, 115, 120
    MOVE G6A, 90, 70, 145, 105, 120
    MOVE G6B, 80
    MOVE G6C, 120
    WAIT

    '다리 벌리기
    MOVE G6D, 80, 40, 175, 105, 120
    MOVE G6A, 80, 70, 145, 105, 120
    WAIT

    '다리기울이기 (왼쪽)
    MOVE G6D, 70, 40, 175, 105, 120
    MOVE G6A, 90, 70, 145, 105, 120
    WAIT
...
Stair_Up2cm:
    ...
    GOSUB Leg_motor_mode2	
    SPEED 5
    MOVE G6A, 114, 90, 100, 143,95,
    MOVE G6D,90,  90, 140,  60, 105
    WAIT
    ...
    SPEED 6
    MOVE G6A, 110, 90, 110, 120,97,
    MOVE G6D,80,  70, 110,  135, 112
    MOVE G6B,110,40
    MOVE G6C,110,40
    WAIT
