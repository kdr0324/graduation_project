...
Stair_Down2cm:
    ...
    ''''''''
    SPEED 8
    MOVE G6D, 108,  25, 150,  160, 97
    MOVE G6A,102, 100, 165, 50, 97
    WAIT
	GOSUB All_motor_mode3
	RETURN

  	SPEED 8
    MOVE G6D, 115,  20, 160,  160, 95
    MOVE G6A,108, 100, 165, 50, 97
    WAIT

	SPEED 8
    MOVE G6D, 95,  45, 150,  140, 100
    MOVE G6A,105, 120, 145, 70, 100
    WAIT

	RETURN 

    SPEED 8
    MOVE G6A, 108, 163,  77,  90,  92,
    MOVE G6D,  95,  20, 143, 164, 107,
