...
HEAD_DOWN_50:
    ...
    MOVE G6D, 100, 70, 145, 100, 100, 100
    MOVE G6B, 100, 30, 80, 100, 100, 100
    MOVE G6C, 100, 30, 80, 100, 150, 100
    WAIT
...
MINE_RUN_READY:
    ...
    MOVE G6D, 100, 70, 145, 105, 105
    WAIT

    '왼발들기
    MOVE G6A, 80, 80, 125, 109, 110
...
Walking:
    ...
    MOVE G6A,108,  74, 147,  93,  96
    WAIT

    SPEED 4
    MOVE G6D,110,  74, 147, 93,  96
...
Stair_Up4cm:
    ...
    DELAY 100
    SPEED 10
    MOVE G6A, 100, 110, 60, 40, 100
    MOVE G6D, 100, 110, 60, 40, 100
    MOVE G6B, 185, 140, 100, , , 100
    MOVE G6C, 185, 140, 100, , 185
    WAIT

    MOVE G6A, 100, 160, 60, 40, 100
    MOVE G6D, 100, 160, 60, 45, 100
...
Turn_Right_5:
    ...
    SPEED 7
    MOVE G6D, 100, 100, 145, 97, 100
    MOVE G6A, 100,  50, 145, 97, 100
    WAIT
...
Turn_Right_45:
    ...
    HIGHSPEED SETON
    SPEED 7
    MOVE G6D,95, 110, 145,  60, 105, 100
    MOVE G6A,95,  30, 145, 140, 105, 100
    WAIT
    HIGHSPEED SETOFF
    SPEED 10
    MOVE G6D,90, 110, 145,  60, 105, 100
    MOVE G6A,90,  30, 145, 140, 105, 100
    WAIT
...
SideMove_Left_10: '
    ...
    '
    '    SPEED 10
    '    MOVE G6A, 95,  70, 147, 100, 104
    '    MOVE G6D,103,  70, 147, 100,  98
    '    MOVE G6B,100
    '    MOVE G6C,100
    '    WAIT
    '
    ...
    '
    '    SPEED 10
    '    MOVE G6A, 88,  65, 152,  98, 110
    '    MOVE G6D,108,  70, 145, 100,  97
    '    MOVE G6B,100,40
    '    MOVE G6C,100,40
    '    WAIT
    '
    ...
    '
    '    SPEED 7
    '    MOVE G6D, 97,  70, 145, 100, 103
    '    MOVE G6A,97,  70, 145, 100,  103
    '    MOVE G6B,100
    '    MOVE G6C,100
    '    WAIT
...
SideMove_Left_30:
    ...
    SPEED 7
    MOVE G6A, 90,  84, 120, 112, 108, 100
    MOVE G6D, 96,  70, 145, 100, 102, 100
    WAIT

    SPEED 6
    MOVE G6A,102,  70, 145, 100, 100, 100
    MOVE G6D, 90,  72, 140, 103, 110, 100
    WAIT
...
SideMove_Right_30:
    ...
    SPEED 7
    MOVE G6D, 90,  84, 120, 112, 108, 100
    MOVE G6A, 96,  70, 145, 100, 102, 100
    WAIT

    SPEED 6
    MOVE G6D,102,  70, 145, 100, 100, 100
    MOVE G6A, 90,  72, 140, 103, 110, 100
    WAIT
...
SideMove_Left_70:
    ...
    SPEED 10
    MOVE G6A, 100,  70, 130, 112, 102, 100
    MOVE G6D,100,  70, 145, 100, 105, 100
    WAIT

    SPEED 13
    MOVE G6A,102,  70, 145, 100, 100, 100
    MOVE G6D, 90,  72, 140, 103, 108, 100
    WAIT
...
Golf_Kick:
    ...
    SPEED 10
    '왼발스윙
    MOVE G6D,114,  75, 145,  90,  95	
    MOVE G6A, 83,  25, 172,  115, 114
    MOVE G6B,50
    MOVE G6C,150
    WAIT
...
Wake_Up:
    ...
    SPEED 12	
    MOVE G6A,  100, 165,  35, 162, 101
    MOVE G6D,  100, 165,  35, 162, 100
    MOVE G6B,  155, 15, 90
    MOVE G6C,  155, 15, 90
    WAIT
...
Stair_Down2cm:
    ...
    SPEED 4
    MOVE G6D, 88,  50, 152,  100, 110
    MOVE G6A,110,  68, 145, 110,  97
    MOVE G6B,100,40
    MOVE G6C,100,40
    WAIT
    DELAY 400
    ...
    SPEED 5
    MOVE G6D, 90,  20, 150,  140, 110
    MOVE G6A,112,  68, 145, 100, 97
    WAIT

    DELAY 500

    SPEED 8
    MOVE G6D, 108,  25, 155,  160, 94
    MOVE G6A,106, 100, 165, 50, 94
    WAIT

    DELAY 400

    SPEED 8
    MOVE G6D, 105,  25, 150,  160, 94
    MOVE G6A,102, 100, 165, 50, 96
    WAIT
    GOSUB All_motor_mode3
    ...
    SPEED 8
    MOVE G6A, 100, 163,  77,  81,  98,
    MOVE G6D,  98,  17, 143, 164, 102,
    MOVE G6B, 114,  42,  80,  ,  ,
    MOVE G6C, 108,  49,  81,  ,  ,
    WAIT

    SPEED 8
    MOVE G6A, 100, 163,  77,  81,  100,
    MOVE G6D,  98,  80, 55, 164, 100,
    MOVE G6B, 114,  42,  80,  ,  ,
    MOVE G6C, 108,  49,  81,  ,  ,
    WAIT

    SPEED 4
    MOVE G6D, 98, 74, 130, 112,101,
    MOVE G6A, 98, 74, 130,  112, 101
    MOVE G6B,110,40
    MOVE G6C,110,40
    WAIT
...
Stair_Up2cm:
    ...
    SPEED 4
    MOVE G6A, 88,  75, 152,  90, 110
    MOVE G6D,110,  68, 145, 100,  97
    MOVE G6B,100,40
    MOVE G6C,100,40
    WAIT
    DELAY 400
    ...
    SPEED 5
    MOVE G6A, 109, 70, 100, 160, 98,
    MOVE G6D,90,  115, 135,  70, 102
    MOVE G6B,160,50
    MOVE G6C,160,40
    WAIT
    ...
    SPEED 4
    MOVE G6A, 113, 95, 80, 160,95,
    MOVE G6D,88,  125, 135,  55, 105
    MOVE G6B,180,50
    MOVE G6C,180,30
    WAIT
    ...
    GOSUB Leg_motor_mode2	
    SPEED 5
    MOVE G6A, 113, 90, 100, 143,95,
    MOVE G6D,90,  115, 125,  60, 105
    WAIT

    DELAY 300

    SPEED 9
    MOVE G6A, 114, 90, 100, 140,95,
    MOVE G6D,90,  120, 40,  140, 112
    WAIT

    SPEED 9
    MOVE G6A, 114, 90, 100, 135,95,
    MOVE G6D,90,  120, 40,  140, 112


    SPEED 6
    MOVE G6A, 114, 90, 110, 120,95,
    MOVE G6D,90,  80, 90,  145, 112
    MOVE G6B,140,50
    MOVE G6C,140,30
    WAIT
    ...
    SPEED 6
    MOVE G6A, 113, 90, 110, 123,97,
    MOVE G6D,95,  75, 110,  135, 112
    MOVE G6B,110,40
    MOVE G6C,110,40
    WAIT

    SPEED 2
    MOVE G6A, 98, 90, 110, 123,97,
    MOVE G6D,98,  75, 110,  135, 112
    MOVE G6B,110,40
    MOVE G6C,110,40
    WAIT
    ...
    SPEED 5
    MOVE G6D, 98, 85, 110, 125,101,
    MOVE G6A,98,  90, 110,  120, 101
    MOVE G6B,110,40
    MOVE G6C,110,40
    WAIT
    GOSUB GYRO_OFF
...
Stair_Down4cm:
    ...
    SPEED 10
    MOVE G6A,100, 145,  36, 137, 102
    MOVE G6D,100, 145,  36, 137, 102
    WAIT
    ...
    SPEED 2
    MOVE G6A,100, 140,  36, 87, 102
    MOVE G6D,100, 140,  36, 87, 102
    MOVE G6B,40,  30, 80
    MOVE G6C,40,  30, 80
    WAIT
    ...
    SPEED 10
    MOVE G6A,100, 100,  36, 127, 102
    MOVE G6D,100, 145,  36, 87, 102
    MOVE G6B,40,  30, 80
    MOVE G6C,40,  30, 80
    WAIT

    SPEED 10
    MOVE G6A,100, 70,  36, 157, 102
    MOVE G6D,100, 145,  36, 87, 102
    MOVE G6B,40,  30, 80
    MOVE G6C,40,  30, 80
    WAIT
    ...
    SPEED 3
    MOVE G6A,100, 115,  73, 70, 102
    MOVE G6D,100, 150,  25,87, 102
    MOVE G6B,40,  30, 80
    MOVE G6C,40,  30, 80
    WAIT
    ...
    SPEED 10
    MOVE G6A,100, 100,  75, 87, 102
    MOVE G6D,100, 100,  73, 87, 102
    MOVE G6B,40,  30, 85
    MOVE G6C,40,  30, 80
    WAIT

    '    SPEED 10
    '    MOVE G6A,100, 100,  70, 77, 102
    '    MOVE G6D,100, 100,  70, 77, 102
    '    MOVE G6B,40,  30, 80
    '    MOVE G6C,40,  30, 80
    '    WAIT
    ...
    GOSUB Leg_motor_mode2
    SPEED 10
    MOVE G6A,100, 150,  50, 87, 102
    MOVE G6D,100, 150,  50, 87, 102
    MOVE G6B,20,  30, 80
    MOVE G6C,20,  30, 80
    WAIT

    SPEED 5
    MOVE G6A,100, 150,  50, 110, 102
    MOVE G6D,100, 150,  50, 110, 102
    MOVE G6B,40,  30, 80
    MOVE G6C,40,  30, 80
    WAIT
...
Trap:
    ...
    '팔뻗기
    SPEED 5
    MOVE G6B,  185,  65,  70, 100, 100, 100
    MOVE G6C,  185,  65,  70, 100, 175, 100
    WAIT
    ...
    DELAY 300
    SPEED 5
    MOVE G6A,110, 143,  28, 162, 100, 100
    MOVE G6D, 95, 143,  28, 162, 100, 100
    WAIT
    ...
    GOSUB Arm_motor_mode1
    SPEED 10
    MOVE G6A,100, 123,  138, 122, 100, 100
    MOVE G6D,100, 123,  138, 122, 100, 100
    MOVE G6B,  185,  65,  70, 100, 100, 100
    MOVE G6C,  185,  65,  70, 100, 175, 100
    WAIT
    DELAY 500
    ...
    SPEED 5
    'HIGHSPEED SETON
    MOVE G6A,100,  56, 110,  15, 100, 100
    MOVE G6D,100,  71, 177, 152, 100, 100
    MOVE G6B,  175,  65,  70, 100, 100, 100
    MOVE G6C,  175,  65,  70, 100, 175, 100
    WAIT
    ...
    SPEED 5
    MOVE G6A,100,  60, 110, 15, 100, 100
    MOVE G6D,100,  60, 110, 23, 100, 100
    MOVE G6B,  185,  65,  70, 100, 100, 100
    MOVE G6C,  185,  65,  70, 100, 175, 100
    ...
    SPEED 5
    MOVE G6A,100,  60, 100,  13, 100, 100
    MOVE G6D,100,  60, 100,  21, 100, 100
    MOVE G6B,  188,  50,  70, 100, 100, 100
    MOVE G6C,  188,  50,  70, 100, 190, 100
...
Hurdle_1:
    ...
    MOVE G6D, 100,  75, 144,  94,  98, 100
    MOVE G6B,  188,  100,  81, 100, 100, 100
    MOVE G6C,  190,  100,  81, 100, 180, 100
    WAIT
    ...
    MOVE G6A,  98,  73, 145,  96, 100, 100
    MOVE G6D, 100,  75, 144,  94,  98, 100
    MOVE G6B,  188,  20,  90, 100, 100, 100
    MOVE G6C,  190,  20,  90, 100, 180, 100
    WAIT
    ...
    MOVE G6A, 100,  80, 127, 110, 100, 100
    MOVE G6D, 102,  80, 124, 111,  98, 100
    MOVE G6B, 188,  21,  81, 100, 100, 100
    MOVE G6C, 190,  22,  81, 100, 180, 100
    WAIT

    '허리숙이기
    SPEED 6
    MOVE G6A, 100,  90, 127, 150, 100, 100
    MOVE G6D, 102,  94, 124, 151,  98, 100
    MOVE G6B, 188,  21,  81, 100, 100, 100
    MOVE G6C, 190,  22,  81, 100, 180, 100
    WAIT
    ...
    SPEED 15 '10->15
    HIGHSPEED SETON
    MOVE G6A, 100,  89, 133, 163, 100 100
    MOVE G6D, 102, 100,  80,  10,  96, 100
    MOVE G6B, 190,  22,  81, 100, 100, 100
    MOVE G6C, 189,  24,  81, 100, 180, 100
    HIGHSPEED SETOFF
    WAIT
    ...
    SPEED 15
    HIGHSPEED SETON
    MOVE G6A, 105,  100, 80, 10,  100, 100
    MOVE G6D, 105, 100,  80,  10,  100, 100
    HIGHSPEED SETOFF
    WAIT
    ...
    SPEED 15
    HIGHSPEED SETON
    MOVE G6A, 100, 120, 55, 30,  99, 100
    MOVE G6D, 102, 120,  55,  30, 99, 100
    MOVE G6B, 190,  160,  81, 100, 100, 100
    MOVE G6C, 189,  160,  81, 100, 180, 100
    HIGHSPEED SETOFF
    WAIT
    ...
    SPEED 15 '10->15
    HIGHSPEED SETON
    MOVE G6A, 100, 100,  110,  10, 190, 100
    MOVE G6D, 102, 100,  110,  10, 190, 100
    HIGHSPEED SETOFF
    WAIT
...
MAIN1:
    ON A GOTO MAIN, 리모컨_1, 리모컨_2, 리모컨_3, 리모컨_4, 리모컨_5, 리모컨_6, 리모컨_7, 리모컨_8, 리모컨_9, 리모컨_10, 기본자세_, 고개정면_, 고개아래20_, 고개아래80_, 고개오른쪽90아래35_, 고개아래50_, 고개아래60_, 함정_, 계단내려가기4cm_, 다리벌려달리기_, 계단올라가기2cm_, 계단내려가기2cm_, 계단올라가기4cm_, 계단내려가기4cm_손집기_, 왼발_공차기_, 허들넘어가기_, 계단치기_, 계단치기뒤로_, 계단치기_짧게_, 무제_5_, 전진달리기5_, 전진달리기10_, 전진달리기15_, 전진달리기20_, 전진달리기25_, 전진달리기30_, 전진달리기35_, 전진달리기40_, 전진달리기45_, 전진달리기50_, 전진보행반의반보_, 전진보행반보_, 전진보행한보_, 무제_8_, 무제_9_, 왼쪽턴5_, 오른쪽턴5_, 왼쪽턴15_, 오른쪽턴15_, 왼쪽턴30_, 오른쪽턴30_, 왼쪽턴45_, 오른쪽턴45_, 무제_10_, 무제_11_, 왼쪽이동10_, 오른쪽이동10_, 왼쪽이동30_, 오른쪽이동30_, 왼쪽이동50_, 오른쪽이동50_, 왼쪽이동70_, 오른쪽이동70_
    GOTO MAIN
...
왼쪽이동30_: '58
    GOSUB SideMove_Left_30
    Send = "A"
    ETX 4800, Send
    GOTO MAIN

오른쪽이동30_: '59
    GOSUB SideMove_Right_30
    Send = "A"
    ETX 4800, Send
    GOTO MAIN
