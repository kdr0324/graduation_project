...
Floor_Sweeping:
	...
	MOVE G6A, 95,  80, 125, 110, 104
    MOVE G6D,110,  70, 145, 105, 102
    MOVE G6B, 85
    MOVE G6C,115
    WAIT
    
    MOVE G6A,105,  70, 140, 110, 100
    MOVE G6D, 95,  80, 145,  80, 102
    WAIT

	MOVE G6D, 95,  80, 125, 110, 104
    MOVE G6A,110,  70, 145, 105, 102
    MOVE G6C, 85
    MOVE G6B,115
    WAIT
    
    MOVE G6D,105,  70, 140, 110, 100
    MOVE G6A, 95,  80, 145,  80, 102
    WAIT
...
Floor_Sweep_End:
	...
	SPEED 7
	MOVE G6A, 95,  85, 125, 100, 104
    MOVE G6D,104,  70, 145,  95, 102
    MOVE G6B, 100
    MOVE G6C,100
    WAIT
...
Floor_Sweep_7:
	GOSUB Floor_Sweep_Ready
	GOSUB Floor_Sweeping
	GOSUB Floor_Sweeping
	GOSUB Floor_Sweeping
	GOSUB Floor_Sweep_End
